...
export default function MediaDigital() {
  ...
  return (
    <section id="services" className="py-14 sm:py-20 bg-brand-white border-t border-brand-charcoal/5 relative overflow-hidden select-none font-sans">
      <div id="build-plan" className="absolute -top-24 left-0 pointer-events-none" />
      <div className="max-w-6xl mx-auto px-6 md:px-12 relative z-10 flex flex-col items-center text-center space-y-8 sm:space-y-12">
