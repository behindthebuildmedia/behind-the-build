          ...
          >
            ...
            <div className="space-y-4 pt-10 border-t border-[#212121]/10">
              ...
              <div className="flex items-center gap-6 text-[#212121]/60">
                <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="hover:text-[#C8041C] transition-colors">
                  <InstagramIcon />
                </a>
                <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="hover:text-[#C8041C] transition-colors">
                  <LinkedinIcon />
                </a>
                <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="hover:text-[#C8041C] transition-colors">
                  <YoutubeIcon />
                </a>
                <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="hover:text-[#C8041C] transition-colors">
                  <TwitterIcon />
                </a>
              </div>
            </div>
